...
bool FindBarWnd::Create(MainWindow* mainWin) {
    ...
    {
        DWORD style =
            WS_CHILD | WS_VISIBLE | TBSTYLE_FLAT | TBSTYLE_LIST | CCS_NODIVIDER | CCS_NORESIZE | CCS_NOPARENTALIGN;
        HINSTANCE hinst = GetModuleHandleW(nullptr);
        hwndBtns =
            CreateWindowExW(0, TOOLBARCLASSNAMEW, nullptr, style, 0, 0, 0, 0, hwnd, (HMENU) nullptr, hinst, nullptr);
