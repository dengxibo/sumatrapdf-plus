...
enum {
    ...
    CmdSetPdfDocumentColorModeAuto = 430,
    CmdSetPdfDocumentColorModeBlack = 431,
    CmdSetPdfDocumentColorModeLight = 432,
    CmdLookupSelection = 433,
    CmdToggleEngineeringDrawingEnhance = 434,
    CmdReadAloud = 435,
    CmdPauseReadAloud = 436,
    CmdContinueReadAloud = 437,
    CmdStopReadAloud = 438,
    CmdReadAloudFromTopPage = 439,
    CmdReadAloudFromCursor = 440,
    CmdReadAloudSelection = 441,
    CmdFindToggleMatchWholeWord = 442,
    CmdAssociateCommonFileTypes = 443,
    CmdSetEbookLatinFont = 444,
    CmdSetEbookCjkFont = 445,
    CmdEbookFontSizeDecrease = 446,
    CmdEbookFontSizeIncrease = 447,
    CmdPdfTocAddAfter = 448,
    CmdPdfTocAddChild = 449,
    CmdPdfTocEdit = 450,
    CmdPdfTocDelete = 451,
    CmdPdfTocMoveUp = 452,
    CmdPdfTocMoveDown = 453,
    CmdPdfTocPromote = 454,
    CmdPdfTocDemote = 455,
    CmdEbookFontSizeReset = 456,
    CmdNone = 457,
