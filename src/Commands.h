...
enum {
    ...
    CmdToggleChmUI = 424,
    CmdSearchSelectionWithYoudaoDict = 425,
    CmdToggleLightDarkTheme = 426,
    CmdAnalyzeSelectionWithDoubao = 427,
    CmdToggleDoubleClickWordLookup = 428,
    CmdTogglePreservePdfImages = 429,
    CmdToggleJoinSplitPdfImages = 430,
    CmdSetPdfDocumentColorModeAuto = 431,
    CmdSetPdfDocumentColorModeBlack = 432,
    CmdSetPdfDocumentColorModeLight = 433,
    CmdLookupSelection = 434,
    CmdToggleEngineeringDrawingEnhance = 435,
    CmdReadAloud = 436,
    CmdPauseReadAloud = 437,
    CmdContinueReadAloud = 438,
    CmdStopReadAloud = 439,
    CmdReadAloudFromTopPage = 440,
    CmdReadAloudFromCursor = 441,
    CmdReadAloudSelection = 442,
    CmdFindToggleMatchWholeWord = 443,
    CmdAssociateCommonFileTypes = 444,
    CmdSetEbookLatinFont = 445,
    CmdSetEbookCjkFont = 446,
    CmdEbookFontSizeDecrease = 447,
    CmdEbookFontSizeIncrease = 448,
    CmdPdfTocAddAfter = 449,
    CmdPdfTocAddChild = 450,
    CmdPdfTocEdit = 451,
    CmdPdfTocDelete = 452,
    CmdPdfTocMoveUp = 453,
    CmdPdfTocMoveDown = 454,
    CmdPdfTocPromote = 455,
    CmdPdfTocDemote = 456,
    CmdEbookFontSizeReset = 457,
    CmdOcrCurrentPage = 458,
    CmdOcrDocument = 459,
    CmdToggleAutoOcr = 460,
    CmdOcrRegion = 461,
    CmdOcrCancel = 462,
    CmdSaveSearchablePdf = 463,
    CmdExtractPdfToc = 464,
    CmdPdfTocCalibrate = 465,
