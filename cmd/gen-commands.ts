...
export const commands = [
    ...
    "CmdSaveAnnotations", "Save changes to existing PDF",
    "CmdSaveAnnotationsNewFile", "Save changes to a new PDF",
    ...
    "CmdEbookFontSizeDecrease", "Ebook Font Size: Decrease",
    "CmdEbookFontSizeIncrease", "Ebook Font Size: Increase",
    "CmdPdfTocAddAfter", "PDF TOC: Add Item After",
    "CmdPdfTocAddChild", "PDF TOC: Add Child Item",
    "CmdPdfTocEdit", "PDF TOC: Edit Item",
    "CmdPdfTocDelete", "PDF TOC: Delete Item",
    "CmdPdfTocMoveUp", "PDF TOC: Move Item Up",
    "CmdPdfTocMoveDown", "PDF TOC: Move Item Down",
    ...
    "CmdOcrCurrentPage", "Recognize Current Page",
    "CmdOcrDocument", "Recognize All Scanned Pages (Fast)",
    "CmdToggleAutoOcr", "Toggle Auto OCR",
    "CmdOcrRegion", "OCR Region",
    "CmdOcrCancel", "Cancel OCR",
    "CmdSaveSearchablePdf", "Save as Searchable PDF",
    ...
    "CmdOcrFullDocumentModeFast", "Full-document OCR Mode: Fast",
