...
def speed_row(speed: str, very_slow: str, slow: str, normal: str, fast: str, faster: str, fastest: str) -> tuple[str, ...]:
    return (
        speed,
        f"{very_slow} (0.5×)",
        f"{slow} (0.75×)",
...
SPEED_BY_LANG: dict[str, tuple[str, ...]] = {
    "af": speed_row("Spoed", "Baie stadig", "Stadig", "Normaal", "Vinnig", "Vinniger", "Vinnigste"),
    "am": speed_row("Արագություն", "Շատ դանդաղ", "Դանդաղ", "Նորմալ", "Արագ", "Ավելի արագ", "Ամենաարագ"),
    "ar": speed_row("السرعة", "بطيء جداً", "بطيء", "عادي", "سريع", "أسرع", "الأسرع"),
    "az": speed_row("Sürət", "Çox yavaş", "Yavaş", "Normal", "Sürətli", "Daha sürətli", "Ən sürətli"),
    "bg": speed_row("Скорост", "Много бавно", "Бавно", "Нормално", "Бързо", "По-бърzo", "Най-бърzo"),
    "bn": speed_row("গতি", "খুব ধীর", "ধীর", "স্বাভাবিক", "দ্রুত", "দ্রুততর", "সবচেয়ে দ্রুত"),
    "br": speed_row("Velocidade", "Muito lento", "Lento", "Normal", "Rápido", "Mais rápido", "Mais rápido ainda"),
    "bs": speed_row("Brzina", "Vrlo sporo", "Sporo", "Normalno", "Brzo", "Brže", "Najbrže"),
    "by": speed_row("Хуткасць", "Вельмі павольна", "Павольна", "Нармальная", "Хутка", "Хутчэй", "Найхутчейшая"),
    "ca": speed_row("Velocitat", "Molt lent", "Lent", "Normal", "Ràpid", "Més ràpid", "El més ràpid"),
    "ca-xv": speed_row("Velocitat", "Molt lent", "Lent", "Normal", "Ràpid", "Més ràpid", "El més ràpid"),
    "cn": speed_row("语速", "极慢", "慢", "正常", "较快", "快", "最快"),
    "co": speed_row("Velocità", "Assai lentu", "Lentu", "Normale", "Veloce", "Più veloce", "Velocissimu"),
    "cy": speed_row("Cyflymder", "Araf iawn", "Araf", "Arferol", "Cyflym", "Cyflymach", "Cyflymaf"),
    "cz": speed_row("Rychlost", "Velmi pomalu", "Pomalu", "Normální", "Rychle", "Rychleji", "Nejrychleji"),
    "de": speed_row("Geschwindigkeit", "Sehr langsam", "Langsam", "Normal", "Schnell", "Schneller", "Am schnellsten"),
    "dk": speed_row("Hastighed", "Meget langsom", "Langsom", "Normal", "Hurtig", "Hurtigere", "Hurtigst"),
    "el": speed_row("Ταχύτητα", "Πολύ αργά", "Αργά", "Κανονικά", "Γρήγορα", "Πιο γρήγορα", "Πιο γρήγορα ακόμα"),
    "es": speed_row("Velocidad", "Muy lento", "Lento", "Normal", "Rápido", "Más rápido", "Más rápido aún"),
    "et": speed_row("Kiirus", "Väga aeglane", "Aeglane", "Tavaline", "Kiire", "Kiirem", "Kiireim"),
    "eu": speed_row("Abiadura", "Oso motela", "Motela", "Normal", "Azkar", "Azkarrago", "Azkarrena"),
    "fa": speed_row("سرعت", "خیلی آهسته", "آهسته", "عادی", "سریع", "سریع‌تر", "سریع‌ترین"),
    "fi": speed_row("Nopeus", "Erittäin hidas", "Hidas", "Normaali", "Nopea", "Nopeampi", "Nopein"),
    "fo": speed_row("Hasti", "Serliga seint", "Seint", "Vanligt", "Skjótt", "Skjótari", "Skjótast"),
    "fr": speed_row("Vitesse", "Très lent", "Lent", "Normal", "Rapide", "Plus rapide", "Le plus rapide"),
    "fy-nl": speed_row("Faas", "Heul stadich", "Stadich", "Normaal", "Fluch", "Flugger", "Fluchst"),
    "ga": speed_row("Luas", "An-mhall", "Mall", "Gnáth", "Tapa", "Níos tapúla", "Is tapúla"),
    "gl": speed_row("Velocidade", "Moi lento", "Lento", "Normal", "Rápido", "Máis rápido", "O máis rápido"),
    "he": speed_row("מהירות", "איטי מאוד", "איטי", "רגיל", "מהיר", "מהיר יותר", "הכי מהיר"),
    "hi": speed_row("गति", "बहुत धीमा", "धीमा", "सामान्य", "तेज़", "तेज़तर", "सबसे तेज़"),
    "hr": speed_row("Brzina", "Vrlo sporo", "Sporo", "Normalno", "Brzo", "Brže", "Najbrže"),
    "hu": speed_row("Sebesség", "Nagyon lassú", "Lassú", "Normál", "Gyors", "Gyorsabb", "Leggyorsabb"),
    "id": speed_row("Kecepatan", "Sangat lambat", "Lambat", "Normal", "Cepat", "Lebih cepat", "Tercepat"),
    "it": speed_row("Velocità", "Molto lento", "Lento", "Normale", "Veloce", "Più veloce", "Velocissimo"),
    "ja": speed_row("速度", "とても遅い", "遅い", "標準", "やや速い", "速い", "最速"),
    "jv": speed_row("Kacepetan", "Banget alon", "Alon", "Normal", "Cepet", "Luwih cepet", "Paling cepet"),
    "ka": speed_row("სიჩქარე", "ძალიან ნელი", "ნელი", "ნორმალური", "სწრაფი", "უფრო სწრაფი", "ყველაზე სწრაფი"),
    "kr": speed_row("속도", "매우 느리게", "느리게", "보통", "빠르게", "더 빠르게", "가장 빠르게"),
    "ku": speed_row("Lezîn", "Pir hêdî", "Hêdî", "Normal", "Bilez", "Bileztir", "Herî bilez"),
    "kw": speed_row("Sppyd", "Mor solabrys", "Mor", "Normal", "Skwith", "Skwitha", "Skwithaf"),
    "lt": speed_row("Greitis", "Labai lėtai", "Lėtai", "Normalu", "Greitai", "Greičiau", "Greičiausiai"),
    "lv": speed_row("Ātrums", "Ļoti lēni", "Lēni", "Normāli", "Ātri", "Ātrāk", "Visātrāk"),
    "mk": speed_row("Брзина", "Многу бавно", "Бавно", "Нормално", "Брzo", "Побрzo", "Најбрzo"),
    "ml": speed_row("വേഗത", "വളരെ മന്ദം", "മന്ദം", "സാധാരണ", "വേഗത്തിൽ", "കൂടുതൽ വേഗത്തിൽ", "ഏറ്റവും വേഗത്തിൽ"),
    "mm": speed_row("မြန်နှုန်း", "အလွန်နှေး", "နှေးကွေး", "ပုံမှန်", "မြန်", "ပိုမြန်", "အမြန်ဆုံး"),
    "my": speed_row("Kelajuan", "Sangat perlahan", "Perlahan", "Normal", "Laju", "Lebih laju", "Paling laju"),
    "ne": speed_row("गति", "धेरै बिस्तारै", "बिस्तारै", "सामान्य", "छिटो", "छिटो", "सबैभन्दा छिटो"),
    "nl": speed_row("Snelheid", "Zeer langzaam", "Langzaam", "Normaal", "Snel", "Sneller", "Snelst"),
    "nn": speed_row("Fart", "Veldig sakte", "Sakte", "Normal", "Rask", "Raskare", "Raskast"),
    "no": speed_row("Hastighet", "Veldig langsom", "Langsom", "Normal", "Rask", "Raskere", "Raskest"),
    "pa": speed_row("ਰਫ਼ਤਾਰ", "ਬਹੁਤ ਹੌਲੀ", "ਹੌਲੀ", "ਸਧਾਰਨ", "ਤੇਜ਼", "ਹੋਰ ਤੇਜ਼", "ਸਭ ਤੋਂ ਤੇਜ਼"),
    "pl": speed_row("Szybkość", "Bardzo wolno", "Wolno", "Normalnie", "Szybko", "Szybciej", "Najszybciej"),
    "pt": speed_row("Velocidade", "Muito lento", "Lento", "Normal", "Rápido", "Mais rápido", "Mais rápido ainda"),
    "ro": speed_row("Viteză", "Foarte lent", "Lent", "Normal", "Rapid", "Mai rapid", "Cel mai rapid"),
    "ru": speed_row("Скорость", "Очень медленно", "Медленно", "Обычная", "Быстро", "Быстрее", "Максимальная"),
    "sat": speed_row("Speed", "Very slow", "Slow", "Normal", "Fast", "Faster", "Fastest"),
    "si": speed_row("වේගය", "Very slow", "Slow", "Normal", "Fast", "Faster", "Fastest"),
    "sk": speed_row("Rýchlosť", "Veľmi pomaly", "Pomalu", "Normálne", "Rýchlo", "Rýchlejšie", "Najrýchlejšie"),
    "sl": speed_row("Hitrost", "Zelo počasi", "Počasi", "Normalno", "Hitro", "Hitreje", "Najhitreje"),
    "sn": speed_row("Speed", "Very slow", "Slow", "Normal", "Fast", "Faster", "Fastest"),
    "sp-rs": speed_row("Brzina", "Veoma sporo", "Sporo", "Normalno", "Brzo", "Brže", "Najbrže"),
    "sq": speed_row("Shpejtësia", "Shumë ngadalë", "Ngadalë", "Normal", "Shpejt", "Më shpejt", "Më shpejt"),
    "sr-rs": speed_row("Брzina", "Veoma sporo", "Sporo", "Normalno", "Brzo", "Brže", "Najbrže"),
    "sv": speed_row("Hastighet", "Mycket långsam", "Långsam", "Normal", "Snabb", "Snabbare", "Snabbast"),
    "ta": speed_row("வேகம்", "மிகவும் மெதுவாக", "மெதுவாக", "சாதாரணம்", "வேகமாக", "மிக வேகமாக", "அதிக வேகம்"),
    "th": speed_row("ความเร็ว", "ช้ามาก", "ช้า", "ปกติ", "เร็ว", "เร็วขึ้น", "เร็วที่สุด"),
    "tl": speed_row("Bilis", "Napakabagal", "Mabagal", "Normal", "Mabilis", "Mas mabilis", "Pinakamabilis"),
    "tr": speed_row("Hız", "Çok yavaş", "Yavaş", "Normal", "Hızlı", "Daha hızlı", "En hızlı"),
    "tw": speed_row("語速", "極慢", "慢", "正常", "較快", "快", "最快"),
    "uk": speed_row("Швидкість", "Дуже повільно", "Повільно", "Звичайна", "Швидко", "Швидше", "Максимальна"),
    "uz": speed_row("Tezlik", "Juda sekin", "Sekin", "Oddiy", "Tez", "Tezroq", "Eng tez"),
    "vn": speed_row("Tốc độ", "Rất chậm", "Chậm", "Bình thường", "Nhanh", "Nhanh hơn", "Nhanh nhất"),
}
